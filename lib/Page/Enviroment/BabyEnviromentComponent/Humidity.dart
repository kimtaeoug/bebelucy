...
class Humidity extends StatelessWidget {
  ...
  Humidity(Key? key, this._supportUI, this._bebelucyColor, this.titleTextStyle,
      this.valueTextStyle, this.itemTextStyle, this.humidityValue):super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        border: Border.all(color: _bebelucyColor.cornflowerBlue, width: 2),
        borderRadius: BorderRadius.all(Radius.circular(15)),
        boxShadow: [
          BoxShadow(
              color:
              _bebelucyColor.humidityShadow,
              spreadRadius: 2,
              blurRadius: 2,
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: Image.asset('images/humidity_bar.png'),
                      ),
                    ),
                  ),
                  Padding(
              ...
              Align(
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(humidityValue.toString(), style: valueTextStyle),
